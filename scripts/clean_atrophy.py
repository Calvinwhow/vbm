...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--l", "--limit", required=True,
        help="Whether to limit range from 2-5 or not (true/false).")
    return p.parse_args()
...
def main() -> None:
    ...
    clean_arr = clean_values(flo_arr, mask_indices, args.l)
